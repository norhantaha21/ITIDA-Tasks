...
namespace TaskApi.Validators
{
    public class UpdateTaskRequestValidatorTests
    {
        ...
        {
            var request = new UpdateTaskRequestDto { Title = "" };
        ...
        {
            var request = new UpdateTaskRequestDto { Title = new string('a', 201) };
            var result = _validator.Validate(request);
        ...
        {
            var request = new UpdateTaskRequestDto { Title = "<script>alert(1)</script>" };
            var result = _validator.Validate(request);
        ...
        {
            var request = new UpdateTaskRequestDto { Title = "Valid title", DueDate = DateTime.Now.AddDays(-1) };
            var result = _validator.Validate(request);
